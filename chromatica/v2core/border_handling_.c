...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "chromatica.v2core.border_handling_",
        "sources": [
            "/home/runner/work/chromatica/chromatica/chromatica/v2core/border_handling_.pyx"
        ]
    },
    "module_name": "chromatica.v2core.border_handling_"
}
END: Cython Metadata */
...
#define __PYX_HAVE__chromatica__v2core__border_handling_
#define __PYX_HAVE_API__chromatica__v2core__border_handling_
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
static const char* const __pyx_f[] = {
  "chromatica/v2core/border_handling_.pyx",
};
...
/* "chromatica/v2core/border_handling_.pxd":10
...
/* "chromatica/v2core/border_handling_.pxd":15
...
#define __Pyx_MODULE_NAME "chromatica.v2core.border_handling_"
extern int __pyx_module_is_main_chromatica__v2core__border_handling_;
int __pyx_module_is_main_chromatica__v2core__border_handling_ = 0;

/* Implementation of "chromatica.v2core.border_handling_" */
...
/* "chromatica/v2core/border_handling_.pxd":25
 * # Helper Functions
 * # =============================================================================
...
static CYTHON_INLINE __pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_f_10chromatica_6v2core_16border_handling__tri2(__pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_v_x) {
  ...
  /* "chromatica/v2core/border_handling_.pxd":27
 * cdef inline f64 tri2(f64 x) noexcept nogil:
 *     """Triangle wave for mirror mode: maps any value to [0, 1]."""
 *     cdef f64 m = fmod(x, 2.0)             # <<<<<<<<<<<<<<
 *     if m < 0.0:
...
*/
  ...
  /* "chromatica/v2core/border_handling_.pxd":28
 *     """Triangle wave for mirror mode: maps any value to [0, 1]."""
 *     cdef f64 m = fmod(x, 2.0)
 *     if m < 0.0:             # <<<<<<<<<<<<<<
 *         m += 2.0
...
*/
  ...
  if (__pyx_t_1) {
    ...
    /* "chromatica/v2core/border_handling_.pxd":29
 *     cdef f64 m = fmod(x, 2.0)
 *     if m < 0.0:
 *         m += 2.0             # <<<<<<<<<<<<<<
 *     return 1.0 - fabs(m - 1.0)
...
*/
  ...
  /* "chromatica/v2core/border_handling_.pxd":30
 *     if m < 0.0:
 *         m += 2.0
 *     return 1.0 - fabs(m - 1.0)             # <<<<<<<<<<<<<<
 * 
...
/* "chromatica/v2core/border_handling_.pxd":33
 * 
 * 
...
static CYTHON_INLINE int __pyx_f_10chromatica_6v2core_16border_handling__is_out_of_bounds_2d(__pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_v_x, __pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_v_y) {
  ...
  /* "chromatica/v2core/border_handling_.pxd":35
 * cdef inline bint is_out_of_bounds_2d(f64 x, f64 y) noexcept nogil:
 *     """Check if coordinates are outside [0, 1] range."""
 *     return x < 0.0 or x > 1.0 or y < 0.0 or y > 1.0             # <<<<<<<<<<<<<<
 * 
...
/* "chromatica/v2core/border_handling_.pxd":38
 * 
 * 
...
static CYTHON_INLINE __pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_f_10chromatica_6v2core_16border_handling__handle_border_1d(__pyx_t_10chromatica_6v2core_16border_handling__f64 __pyx_v_t, int __pyx_v_border_mode) {
  ...
  /* "chromatica/v2core/border_handling_.pxd":54
 *     cdef f64 result
 * 
...
*/
  switch (__pyx_v_border_mode) {
    ...
    /* "chromatica/v2core/border_handling_.pxd":55
 * 
 *     if border_mode == BORDER_REPEAT:
 *         result = fmod(t, 1.0)             # <<<<<<<<<<<<<<
 *         if result < 0.0:
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":56
 *     if border_mode == BORDER_REPEAT:
 *         result = fmod(t, 1.0)
 *         if result < 0.0:             # <<<<<<<<<<<<<<
 *             result += 1.0
...
*/
    ...
    if (__pyx_t_1) {
      ...
      /* "chromatica/v2core/border_handling_.pxd":57
 *         result = fmod(t, 1.0)
 *         if result < 0.0:
 *             result += 1.0             # <<<<<<<<<<<<<<
 *         return result
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":58
 *         if result < 0.0:
 *             result += 1.0
 *         return result             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":61
 * 
 *     elif border_mode == BORDER_MIRROR:
 *         return tri2(t)             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":60
 *         return result
 * 
 *     elif border_mode == BORDER_MIRROR:             # <<<<<<<<<<<<<<
 *         return tri2(t)
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":64
 * 
 *     else:  # BORDER_CLAMP (default fallback)
 *         if t < 0.0:             # <<<<<<<<<<<<<<
 *             return 0.0
...
*/
    ...
    if (__pyx_t_1) {
      ...
      /* "chromatica/v2core/border_handling_.pxd":65
 *     else:  # BORDER_CLAMP (default fallback)
 *         if t < 0.0:
 *             return 0.0             # <<<<<<<<<<<<<<
 *         elif t > 1.0:
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":66
 *         if t < 0.0:
 *             return 0.0
 *         elif t > 1.0:             # <<<<<<<<<<<<<<
 *             return 1.0
...
*/
    ...
    if (__pyx_t_1) {
      ...
      /* "chromatica/v2core/border_handling_.pxd":67
 *             return 0.0
 *         elif t > 1.0:
 *             return 1.0             # <<<<<<<<<<<<<<
 *         return t
...
*/
    ...
    /* "chromatica/v2core/border_handling_.pxd":68
 *         elif t > 1.0:
 *             return 1.0
 *         return t             # <<<<<<<<<<<<<<
*/
...
static int __pyx_pymod_exec_border_handling_(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_border_handling_},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_border_handling_(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_border_handling_(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_border_handling_(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'border_handling_' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "border_handling_" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_border_handling_", 0);
  ...
  if (__pyx_module_is_main_chromatica__v2core__border_handling_) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "chromatica.v2core.border_handling_")) {
      if (unlikely((PyDict_SetItemString(modules, "chromatica.v2core.border_handling_", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "chromatica/v2core/border_handling_.pyx":1
 * #Empty on purpose             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init chromatica.v2core.border_handling_", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init chromatica.v2core.border_handling_");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
