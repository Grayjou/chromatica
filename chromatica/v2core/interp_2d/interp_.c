...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "chromatica.v2core.interp_2d.interp_",
        "sources": [
            "/home/runner/work/chromatica/chromatica/chromatica/v2core/interp_2d/interp_.pyx"
        ]
    },
    "module_name": "chromatica.v2core.interp_2d.interp_"
}
END: Cython Metadata */
...
#define __PYX_HAVE__chromatica__v2core__interp_2d__interp_
#define __PYX_HAVE_API__chromatica__v2core__interp_2d__interp_
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char* const __pyx_f[] = {
  "chromatica/v2core/interp_2d/interp_.pyx",
...
/* "chromatica/v2core/interp_2d/interp_.pyx":16
 *     BORDER_OVERFLOW,
 * )
 * ctypedef np.float64_t f64             # <<<<<<<<<<<<<<
*/
typedef __pyx_t_5numpy_float64_t __pyx_t_10chromatica_6v2core_9interp_2d_7interp__f64;
...
/* Module declarations from "chromatica.v2core.interp_2d.interp_" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "chromatica.v2core.interp_2d.interp_"
extern int __pyx_module_is_main_chromatica__v2core__interp_2d__interp_;
int __pyx_module_is_main_chromatica__v2core__interp_2d__interp_ = 0;

/* Implementation of "chromatica.v2core.interp_2d.interp_" */
...
#define __pyx_kp_b_PyObject___pyx_t_10chromatica_6v __pyx_string_tab[12]
#define __pyx_kp_b_int_BORDER_CLAMP_BORDER_CONSTANT __pyx_string_tab[13]
...
static int __Pyx_modinit_variable_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    __pyx_t_1 = PyImport_ImportModule("chromatica.v2core.border_handling"); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    while (*__pyx_import_pointer) {
      if (__Pyx_ImportVoidPtr_3_2_3(__pyx_t_1, __pyx_import_name, *__pyx_import_pointer, __pyx_import_current_signature) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __pyx_pymod_exec_interp_(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_interp_},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_interp_(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_interp_(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_interp_(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'interp_' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "interp_" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_interp_", 0);
  ...
  if (__pyx_module_is_main_chromatica__v2core__interp_2d__interp_) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "chromatica.v2core.interp_2d.interp_")) {
      if (unlikely((PyDict_SetItemString(modules, "chromatica.v2core.interp_2d.interp_", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "chromatica/v2core/interp_2d/interp_.pyx":3
...
*/
  ...
  /* "chromatica/v2core/interp_2d/interp_.pyx":1
 * # cython: boundscheck=False, wraparound=False, nonecheck=False, cdivision=True, initializedcheck=False             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init chromatica.v2core.interp_2d.interp_", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init chromatica.v2core.interp_2d.interp_");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{39},{34},{18},{8},{10},{8},{2},{5},{12},{10},{8},{191},{80}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 