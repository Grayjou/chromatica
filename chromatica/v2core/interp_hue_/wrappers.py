...
hue_lerp_between_lines_x_discrete = partial(hue_lerp_between_lines, x_discrete=True)
hue_lerp_between_lines_array_border_x_discrete = partial(
    hue_lerp_between_lines_array_border, x_discrete=True
)
hue_lerp_between_lines_full_x_discrete = partial(
    hue_lerp_between_lines_full, x_discrete=True
)
hue_lerp_between_lines_inplace_x_discrete = partial(
    hue_lerp_between_lines_inplace, x_discrete=True
)
