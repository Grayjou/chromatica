...
class GradientSegmentBuilder:
    ...
    def build_segments_from_scaled_u(
        ...
        Args:
            ...
            input_color_modes: Color spaces of input colors
            color_modes: Interpolation color spaces for each segment
        ...
        first_segment = get_transformed_segment(
            ...
            end_color=colors[1],
            start_color_mode=input_color_modes[0],
            end_color_mode=input_color_modes[1],
        ...
        for seg_idx in range(1, num_segments):
            ...
            new_segment = get_transformed_segment(
                already_converted_start_color=previous_segment.end_as_color_mode(
                    color_modes[seg_idx]
                ),
                end_color=colors[seg_idx + 1],
                end_color_mode=input_color_modes[seg_idx + 1],
                format_type=format_type,
                per_channel_coords=[index_per_channel_coords[seg_idx][1]],
                color_mode=color_modes[seg_idx],
